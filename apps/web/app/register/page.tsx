  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-120px)] max-w-md items-center px-4 py-12">
      <div className="w-full rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-xl font-bold text-moons-navy">Create your Moons account</h1>
        <p className="mt-1 text-sm text-moons-muted">
          Already registered?{' '}
          <Link href="/login" className="font-semibold text-moons-blue hover:underline">
            Login
          </Link>
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            ...
            <div className="mt-2 flex gap-3">
              <label className="flex flex-1 cursor-pointer items-center gap-2 rounded-md border border-slate-300 px-3 py-2 text-sm has-[:checked]:border-moons-blue has-[:checked]:bg-blue-50">
                <input
                  type="radio"
                  name="role"
