...
const socialLinks = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/moonsjob/',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/moons.job/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden>
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61574856263280',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden>
        <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.413c0-3.025 1.792-4.697 4.533-4.697 1.313 0 2.686.236 2.686.236v2.973h-1.513c-1.491 0-1.956.931-1.956 1.887v2.261h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" />
      </svg>
    ),
  },
] as const;
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="mt-4 flex flex-row flex-wrap items-center gap-2.5">
                <a
                  ...
                  className="inline-flex h-11 w-[148px] shrink-0 items-center justify-center overflow-hidden rounded-lg transition hover:opacity-90 sm:h-12 sm:w-[168px]"
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="/badge-google-play.png?v=3"
                ...
                {APP_STORE_URL ? (
                  ...
                  <span
                    className="inline-flex h-11 w-[148px] shrink-0 cursor-default items-center justify-center overflow-hidden rounded-lg opacity-80 sm:h-12 sm:w-[168px]"
